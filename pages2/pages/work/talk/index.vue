<template>
	<view class="wrap">
		...
		<u-sticky style="background-color: white;" zIndex="1">
			<u-tabs :list="listTab" :scrollable="false" itemStyle="height: '44rpx';padding:20rpx 10rpx;ackground-color: white"
				@click="clickTab">
			</u-tabs>
			...
			<view class="view-list-video" @click="onClickVideoItem(item,index)" v-for="(item, index) in listData"
				...
				<view class="view-video-list">
					<view style="display: flex;flex-direction: row;align-items: center;">
						<view style="flex:1;font-size: 30rpx;">视频咨询</view>
					...
					<view style="display: flex;flex-direction: row;">
						...
						<view class=""
							style="color: white;background-color: #409EFF;border-radius: 24rpx;padding: 8rpx 43rpx 11rpx 43rpx;"
