<template>
	<view class="content">
		...
		<view class="view-base">
			...
			<view style="background-color: #F2F2F2;display: flex;flex-direction: row;padding: 22rpx;30rpx">
			...
			<view style="background-color: #F2F2F2;display: flex;flex-direction: row;padding: 22rpx;30rpx">
				...
				<view style="color: red;font-size: 28rpx;margin-left: 20rpx;">
					您提交的证件信息经平台审核为不通过，不通过原因：{{title||'暂无'}}。请重新提交。
				</view>
			</view>
			...
			<view style="display: flex;flex-direction: row;align-items: center;margin-left: 24rpx;margin-top: 20rpx;">
				<view style="display: flex;flex-direction: column;align-items: center;justify-content: center;">
					...
					<u-upload :fileList="fileList2" @afterRead="afterRead" :deletable="false" @delete="deletePic"
						:maxCount="1" name="2">
						<view
