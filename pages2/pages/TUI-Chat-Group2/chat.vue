...
<script>
	...
	import TUIMessageList from '../../components/tui-chat/message-list-group2/index';
	import TUIMessageInput from '../../components/tui-chat/message-input-group2/index';
	...
	export default {
		...
		onLoad(options) {
			...
			eventChannel.on('sendCfCard_', message_ => {
				setTimeout(() => {
					this.sendCustomMessage(message_);
				}, 2000);
			});
		},
		onUnload() {
