		...
		<view class="group-information-box" @show="getgroupProfile">
			<view class="group-box">
				...
				<view @tap="showMoreHandler">
					...
					<image v-if="notShow" class=" icon-right" src="/pages2/static/static/assets/down.svg"></image>
					<image v-if="isShow" class=" icon-right" src="/pages2/static/static/assets/up.svg"></image>
				</view>
			</view>
			<view v-show="!hidden" class="showdetail">
				...
				<view class="box" v-if="showMore">
					<image class="profile-box" src="/pages2/static/static/assets/show.svg" @tap="showMoreMember"></image>
					<text class="nick-box">更多</text>
				</view>
				<view class="left-box">
					<view class="box-group" v-if="addShow">
						<image class="addmember" src="/pages2/static/static/assets/addgroup.svg" @tap="addMember"></image>
						<text class="addmember-text">添加成员</text>
					</view>
					<view class="box-group-quit">
						<image class="quitgroup" src="/pages2/static/static/assets/quitgroup.svg" @tap.stop="quitGroup"></image>
