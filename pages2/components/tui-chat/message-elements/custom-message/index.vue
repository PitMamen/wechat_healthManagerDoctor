<template>
	<view>
		...
		<view v-if="renderDom[0].type === 'CustomArticleMessage'"
			...
			<view class="custom-content">
				<view class="custom-content-title">{{ renderDom[0].title }}</view>
				<view class="custom-content-content"><text style="color: #000000;">标题：</text>{{ renderDom[0].name }}
				</view>
		...
		<view v-if="renderDom[0].type === 'CustomWenJuanMessage'"
			...
			<view class="custom-content">
				<view class="custom-content-title">{{ renderDom[0].title }}</view>
				<view class="custom-content-content"><text style="color: #000000;">内容：</text>{{ renderDom[0].name }}
				</view>
