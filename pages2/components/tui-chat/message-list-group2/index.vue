...
<script>
import TUITextMessage from '../message-elements-group2/text-message/index';
import TUIImageMessage from '../message-elements-group2/image-message/index';
import TUIVideoMessage from '../message-elements-group2/video-message/index';
import TUIAudioMessage from '../message-elements-group2/audio-message/index';
import TUICustomMessage from '../message-elements-group2/custom-message/index';
import TUITipMessage from '../message-elements-group2/tip-message/index';
import TUISystemMessage from '../message-elements-group2/system-message/index';
import TUIFaceMessage from '../message-elements-group2/face-message/index';
import TUIFileMessage from '../message-elements-group2/file-message/index';
...
export default {
	...
	mounted() {
        ...
        this.$bus.$off('scrollToButtom');
		this.$bus.$on('scrollToButtom', this.scrollToButtom);
		...
		scrollToButtom() {
			...
			nodesRef
				.boundingClientRect(res => {
					this.$nextTick(() => {
						//进入页面滚动到底部
                        if (this.scrollTop == res.height){
							this.scrollTop = res.height + 1;
						}else {
