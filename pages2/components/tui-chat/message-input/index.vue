		...
		<view class="TUI-message-input-container">
			...
			<view class="TUI-message-input">
				...
				<view class="TUI-message-input-functions" hover-class="none">
					<image class="TUI-icon" @tap="handleEmoji" src="/pages2/static/static/assets/face-emoji.svg"></image>
			...
			<view v-if="displayFlag === 'extension'" class="TUI-Extensions">
				...
				<view class="TUI-Extension-slot" @tap="handleChuFang" v-if="taskItem.taskDetail.rightsType === 'appointNum'">
				...
				<view class="TUI-Extension-slot" @tap="handleCalling('video')" v-if="taskItem.taskDetail.rightsType === 'videoNum'">
